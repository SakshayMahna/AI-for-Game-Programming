...
float const MAX_PREDICTION = 0.1;
...
Steering kinematic_pursue(Kinematic target, Kinematic character) {
    ...
    direction[1] = target_position[1] - target_position[1];
    ...
    // Calculate new target for kinematic seek
    ...
    Kinematic new_target = Kinematic(new_target_position, target_velocity);
